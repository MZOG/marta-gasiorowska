      	...
      	<h2>Dlaczego dietetyk?</h2>
        		...
        		<div className="col-md-6">
          		<p>
            		...
            		żywieniową społeczeństwa oraz promocją zdrowia. O dietetyku mówi
            		się, że jest specjalistą interdyscyplinarnym, bo posiada wiedzę
            		także z zakresu anatomii, biochemii, medycyny i psychologii.
          		</p>
       		  </div>
						<div className="col-md-6">
          		<p>
            		Sport i odżywianie się w zdrowym stylu życia zawsze mi towarzyszyły.
            		W życiu zawodowym zawsze chciałam robić coś nie tylko z pasją, ale
            		coś, co będzie wiązało się z pomocą dla drugiej osoby. Uśmiech,
            		radość i zadowolenie pacjenta z dobrze przeprowadzonej usługi to
            		najlepsze co możesz otrzymać. Zastanawiałeś/łaś się kiedyś co czuje
            		lekarz z dobrze przeprowadzonej operacji? Jakie towarzyszą mu
            		emocje, gdy przychodzi do niego rodzina pacjenta z podziękowaniami?
            		Przykładów nie trzeba szukać daleko. Na pewno każdy z was wręczył
            		komuś prezent czy pomógł staruszce na ulicy. W odpowiedzi za te
