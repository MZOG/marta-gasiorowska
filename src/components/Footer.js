        ...
        <div className="container footer_component">
          <div className="row">
            <div className="col-md-7 footer_left">
              ...
              <p>"Cudem nie jest to, że skończyłem. Cudem jest to, że miałem odwagę zacząć." - <i>John Bingham</i></p>
            </div>
          </div>
          <div class="col-md-2 footer_middle">
            <ul>
                <li><Link to="/">Home</Link></li>
                <li><Link to="/o-mnie">O mnie</Link></li>
                <li><Link to="/przepisy">Przepisy</Link></li>
                <li><Link to="/dieta-trening">Dieta i Trening</Link></li>
        ...
        <div class="col-md-3 footer_right">
              	...
              	<h6>SKONTAKTUJ SIĘ</h6>
							...
							<div class="footer_svg">
								<a href="tel:1-562-867-5309"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-telephone-fill" viewBox="0 0 16 16">
  								<path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"/>
								</svg></a>
								<a href="mailto:adres e-mail"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-envelope-fill" viewBox="0 0 16 16">
