        ...
        <div className="contact_header">
			  ...
			  <div className="row">
				  <div className="col-md-6 contact_type">
					...
					<div className="col-md-12">
						<div className="contact_svg">
							<a href="https://www.facebook.com/messages/t/100003534104788"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-facebook" viewBox="0 0 16 16">
