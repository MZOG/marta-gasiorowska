  ...
  return (
    ...
    <div className="col-md-12 about_me">
      <p>
        ...
        jadłospisy w odchudzaniu, aktywności fizycznej dla kobiet w ciąży, karmiących piersią i niemowląt oraz w konkretnych
        jednostkach chorobowych tj. otyłość, nadciśnienie tętnicze, wrzody
    ...
    <div className="col-md-12 coocking_discription">
      <p>
        Pasja do układania i przygotowywania posiłków pojawiła się u mnie bardzo
        późno. Mieszkając z rodzicami zawsze miałam gotowy, smaczny i zdrowy
        posiłek. Wszystko podane na zawołanie. Dopiero jak się przeprowadziłam
        trzeba było się ogarnąć i zacząć gotować na własną rękę. Chcialam
        kontynuować zdrowe odżywianie, które wyniosłam z domu. Na co dzień
        jestem osobą zabieganą. Zależało mi na posiłkach szybkich w
        przygotowaniu (a najlepiej jednogarnkowych ). Wyszukiwałam proste dania
        w internecie i gotowałam. I wtedy pojawiło się pierwsze zamiłowanie do
        gotowania. Pasja ta umocniła się, kiedy sama przechodziłam dietę
        odchudzającą. Lubię urozmaicać posiłki. Na diecie dokonywałam
        modyfikacji swoich posiłków. Praktycznie codziennie miałam inne menu. Na
        co dzień w kuchni spędzam większość czasu. Miejsce to stało się moją
        oazą spokoju i relaksu. Z czasem nie patrzyłam na trudność czy szybkość
        przygotowania wyszukanej potrawy, lecz na jej ciekawość i wyobrażalny
        smak. A jeśli robisz już coś z pasją to czas czy trudności jakie
        napotykasz na swojej drodze nie są dla Ciebie przeszkodą. A może Twoją
    ...
    <div className="row sport">
      ...
      <img src={Water} alt="moje zdjęcie na linie" className="img-fluid" />
      </div>
      <div className="col-md-4">
      <img src={Windsurfing} alt="zdjęcie profilowe" className="img-fluid" />
      </div>
      <div className="col-md-4 sport_discrtiption">
        <p>
          Zamiłowanie do gotowania pojawiło się z czasem, ale od dziecka lubiłam
          i lubię aktywność fizyczną. Miałam okazję trenować sztuki walki,
          pływać na windsurfingu oraz brać udział w licznych imprezach
          sportowych nie tylko, aby rywalizować z innymi, ale przede wszystkim
          po to by walczyć z własnymi słabościami i wyznaczać sobie nowe cele,
          których pokonywanie sprawia mi ogromną radość!
        </p>
      </div>
    </div>
    <div className="row sport">
