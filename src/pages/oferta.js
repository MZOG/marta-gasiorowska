      ...
      <div className="motivation_text">
		...
		<div className="col-md-12">
			<div className="offer_list">
						<p>Indywidualne dopasowanie diety na 7 dni (szczególy diety ustalimy podczas wstępnego wywiadu dietetycznego)</p>
						<ul>
							<li>przepisy do każdego posiłku uwzględniając czas przygotowania oraz kaloryczność</li>
							<li>cenne wskazówki, komentarze dotyczące konkretnych produktów, techniki obróbki kulinarnej itp.</li>
							<li>lista zakupów</li>
					...
					<div className="diets_discription">
						<p>UWAGA!</p>
						<p>Przy diecie odchudzającej domowy 7-dniowy plan treningowy na redukcję tkanki tłuszczowej - GRATIS!</p>
					</div>
					<div className="offer_boxes">
			<div className="row">
				<div className="col-md-4 offer_box_one">
			...
			<div className="offer_list">
						<ul>
							<li>7 dniowy plan treningowy dopasowany do Twojego celu treningowego</li>
						</ul>
						<p>Kontrola postępów</p>
						<ul>
